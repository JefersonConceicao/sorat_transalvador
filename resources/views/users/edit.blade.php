...
@section('content-title', 'Atualizar Usuário')
...
@section('content-body')
    ...
    <form action="{{ route('user.update', $user->usu_id_usu) }}" method="POST"> 
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ativo" id="status">                        
                                <option value="1" @if($user->usu_id_gru == "1") selected @endif> Ativo </option>
                                <option value="0" @if($user->usu_id_gru == "0") selected @endif> Inativo </option>
                            </select>

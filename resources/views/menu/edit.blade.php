                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="descricao_menu" value="{{ $dadosMenu->men_nom_descricao }}" />
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2 col-sm-4">
                                <label class="checkbox-inline icheckbox">
                                    <input type="checkbox" id="checkboxModulo" name="flg_menu_modulo" @if($dadosMenu->men_flg_modulo) checked @endif>
                                    Menu Módulo
                                </label>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4">
                                <label class="checkbox-inline icheckbox">
                                    <input type="checkbox" id="checkboxVisitante" name="flg_menu_visitante" @if($dadosMenu->men_flg_menu_guest) checked @endif>
                                    Menu Visitante
                                </label>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-4">
                                <label class="checkbox-inline icheckbox">
                                    <input type="checkbox" id="checkboxAdministrativo" name="flg_menu_admin" @if($dadosMenu->men_flg_menu_admin) checked @endif>
                                    Menu Administrativo
                                </label>
                            </div>
                            ...
                            <div class="col-md-1 col-sm-4">
                                <label class="checkbox-inline icheckbox">
                                    <input type="checkbox" id="checkboxAtivo" name="flg_menu_ativo" @if($dadosMenu->men_flg_ativo) checked @endif>
                                    Ativo
                                </label>
                            </div>
                        </div>

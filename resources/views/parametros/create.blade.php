...
@section('content-title', 'Cadastrar Parametro')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="par_nom_parametro" />
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control has-error" name="par_des_retorno" />
